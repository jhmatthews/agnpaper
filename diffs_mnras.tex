...
%DIF < fullpage
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics[width=1.0\textwidth]{figures/link.png}
%DIFDELCMD < \caption
%DIFDELCMD < {
%DIFDELCMD < %%%
...
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1.0\textwidth]{figures/uvspec.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1.0\textwidth]{figures/uvspec_estfix.png}
\DIFaddendFL \caption
{
