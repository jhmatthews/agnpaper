...
Various unification schemes for quasars and luminous active galactic nuclei (AGN) 
propose that much of their complex phenomenology can be explained by a simple 
geometrical picture involving an accretion disc and associated outflow.
Here, we test this paradigm by utilising our state-of-the-art radiative transfer 
and photoionization code to produce synthetic spectra from simple biconical disc wind models. 
In particular, we expand on our previous work by presenting a model that
exhibits many of the spectral features expected from a quasar unification model.
We find that a simple treatment of clumping (`microclumping') 
allows for a more realistic X-ray luminosity in the model,
while maintaining the ionization state necessary for strong BAL features. 
We examine the X-ray properties of this new model
...
The highest inclination models possess prominent \mg\ and \al\ BALs, the absorption 
...
In addition to the inflowing accreting material, i
