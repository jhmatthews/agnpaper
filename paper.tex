...
LK02, H13 and M15. {\bf We emphasise that the purpose of this
purely kinematic wind model is to provide a simple tool for 
exploring different outflow geometries and kinematics, and
the model itself is not hydrodynamic.}
...
is then given by \citep[e.g.][]{rybickihummer1978}
\begin{equation}
