...
and can be compared to observations. As shown in ~\ref{fig:wind},
...
highlights the first success of our model: clumping means the correct ionization state 
is maintained in the presence of strong X-rays, allowing large resonance line opacities. 
...
all quasars. We do not produce the semi-forbidden 
intercombination lines seen in quasar spectra because we
currently do not have a treatment for semi-forbidden lines.
This is especially noteiceable with the strong [C~\textsc{iii}~1909\AA\, 
