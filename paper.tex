...
for polar BAL outflows \citep{zhou2006}.
...
between quasar to BALQSO samples.  
...
However this effect is small in the UV and optical wavelength regimes, and the 
disc is still anisotropic.
...
An alternative explanation, suggested by \cite{risaliti2011}, is that
the BLR has the same angular distribution of emission as the accretion disc.
They find that EW distributions in quasars are consistent with anisotropic emission 
...
viewed from a fairly narrow range of angles ($0$-$50^\circ$, and could also mean 
...
BAL troughs are wider and deeper when lower ionization species are present,
and high ionization lines have higher blue-edge velocities than the 
lower ionization species.
