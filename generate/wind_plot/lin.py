...
levs = [np.arange(3.4,4.8,0.1), np.arange(7,11,0.1),  np.arange(-3,2,0.2), np.arange(-2,0.1,0.1),np.arange(-4,0,0.1),np.arange(-4,0,0.1),np.arange(40,44,0.1), np.arange(37,42.5,0.2), np.arange(37,42.5,0.2)]
