...
root = "nextgen_a05_79c"
#util.run_py_wind(root,vers="79c",cmds=["1","1","1","M","2","2","-1","i","0","13","3","12","2","0","c","3","q"])
d = r.read_pywind_summary(root)


strings = ["ionO5", "ionO6", "ionN5", "ionC4", "ionAl3", "ionMg2", "ionHe1", "ionHe2", "ionHe3"]
levs = [np.arange(-4,0,0.1), np.arange(-4,0,0.1),  np.arange(-4,0,0.1), np.arange(-4,0,0.1),np.arange(-4,0,0.1),np.arange(-4,0,0.1),np.arange(-4,0,0.1), np.arange(-4,0,0.1), np.arange(-4,0,0.1)]
...
labels = [r'$\rm{log (O\textsc{v}~ion~fraction)}$', r'$\rm{log (O\textsc{vi}~ion~fraction)}$',r'$\rm{log (N\textsc{v}~ion~fraction)}$',r'$\rm{log (C\textsc{iv}~ion~fraction)}$', r'$\rm{log (Al\textsc{iii}~ion~fraction)}$', r'$\rm{log (Mg\textsc{ii}~ion~fraction)}$', r'$\rm{log (He\textsc{i}~ion~fraction)}$',
r'$\rm{log (He\textsc{ii}~ion~fraction)}$', r'$\rm{log (He\textsc{iii}~ion~fraction)}$']
...
for i in range(len(strings)):
	...
	if strings[i] == "ionMg2" or strings[i] == "ionO5" or strings[i] == "ionAl3" or strings[i] == "lineC4":
...
savefig("linear_%s.png" % root, dpi=300)
