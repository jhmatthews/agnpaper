...
\section{Results From An Example Model}

Here we describe the results from an example model,
...
This is due to heating of the plasma by the increased the increased X-ray 
luminosity heating the plasma, while clumping prevents over-ionization.
...
example model agree well with quasar and BALQSO samples for the relevant
inclinations.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 We have demonstrated that our example model successfully reproduces much of
...
equatorial angles ($\sim0$-$45^\circ$), or that {\em both} 
