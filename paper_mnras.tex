...
produce synthetic spectra in the rest-frame UV that have the characteristics of quasars. 
We find that a simple treatment of clumping (`microclumping') 
allows for a more realistic X-ray luminosities, while maintaining the ionization 
...
\item Does significant line emission emerge at low inclinations, with $EW\sim40\AA$ in \civ?
\item Do H recombination lines appear in the spectrum, $EW\sim50\AA$ in \la?
\item Do a small subset of BAL angles produce LoBAL features?
